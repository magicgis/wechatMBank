...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('[name="accmenu"] li').click(function(){
				var acctOpenId =  $(this).data('val');
				$.get("${ctx}//wechat/weixinAccount/select?openId="+acctOpenId, function(data){
	...
	<div id="main">
			...
			<div class="navbar-inner">
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<li class="dropdown">
							<a id="acc" class="dropdown-toggle" data-toggle="dropdown" href="#">${fns:getAcct().acctName}<b class="caret"></b></a>   
							<ul name="accmenu" class="dropdown-menu">
								<c:forEach items="${fns:getCurrtAcct()}" var="accList">
									<li data-val="${accList.acctOpenId}"><a href="">${accList.acctName}</a></li>
								</c:forEach>
							</ul>
						</li>
					</ul>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.yitong.com.cn" target="_blank">Fwy</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
