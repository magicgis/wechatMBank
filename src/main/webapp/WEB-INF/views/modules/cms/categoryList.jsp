...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="cms:category:edit"><li><a href="${ctx}/cms/category/form">分类添加</a></li></shiro:hasPermission>
	</ul>
	<sys:message content="${message}"/>
	<form id="listForm" method="post">
		<table id="treeTable" class="table table-striped table-bordered table-condensed">
			<tr><th>分类名称</th><th>归属机构</th><th>分类模型</th><th style="text-align:center;">排序</th><th title="是否在导航中显示该栏目">导航菜单</th><th title="是否在分类页中显示该栏目的文章列表">栏目列表</th><th>展现方式</th><th>操作</th></tr>
				...
				<tr id="${tpl.id}" pId="${tpl.parent.id ne '1'?tpl.parent.id:'0'}">
					...
					<td>
						...
						<shiro:hasPermission name="cms:category:edit">
							...
							<a href="${ctx}/cms/category/delete?id=${tpl.id}" onclick="return confirmx('要删除该分类及所有子分类项吗？', this.href)">删除</a>
							<a href="${ctx}/cms/category/form?parent.id=${tpl.id}">添加下级分类</a>
						</shiro:hasPermission>
					</td>
				</tr>
			</c:forEach>
